...
export default function RecetasPage() {
  ...
  // Carga el perfil del veterinario: primero localStorage (rápido), luego Supabase (fuente autoritativa)
  useEffect(() => {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      // Guarda en el historial clínico si hay un paciente registrado seleccionado
      if (selectedPatient) {
        const supabase = createClient();
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Retroalimentación del estado de sincronización */}
        {syncStatus === "saved" && (
